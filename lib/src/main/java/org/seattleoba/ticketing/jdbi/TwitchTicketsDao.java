...
public interface TwitchTicketsDao {
    ...
    @SqlUpdate("INSERT INTO twitch_accounts_bevy_tickets (twitch_id, bevy_ticket_id) VALUES (:user_id, :ticket_id)")
    void insert(@Bind("user_id") int userId, @Bind("ticket_id") int ticketNumber);
}
